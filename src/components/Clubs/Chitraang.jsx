...
export default function Chitraang() {
  ...
  return (
    <div className="bg-black p-8 rounded-xl shadow-2xl m-6 max-w-[80%]  mx-auto border-2 border-yellow-600">
      ...
      Literary & Cultural: Chitraang
      </h2>
      <div className="flex justify-center items-center">
        <div className="">
          <h3 className="text-2xl font-semibold text-white mb-4">About: </h3>
          <p className="text-white text-1xl mb-6">
          The primary focus of the graffiti club, Chitraang, is to curate creative ideas that are theme-specific and convey messages through the use of art. The club paints graffiti on the SAC wall and other infrastructure as in, different halls of residence, and stages in and around the campus of NIT Rourkela.
          </p>
        </div>
        <div className="club-logo float-right">
          <img
            src="https://res.cloudinary.com/webwiznitr/image/upload/f_auto,q_70/v1678968569/AAA01_4x_-_Prachi_pratikshya_Dansana_eejj45.png"
      ...
      <div className="mt-9 flex items-center">
        <a
          href="https://www.instagram.com/chit.r.aang/?hl=en"
          target="_blank"
